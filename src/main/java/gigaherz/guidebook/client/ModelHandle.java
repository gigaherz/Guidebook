...
public class ModelHandle
{
    ...
    private static final EnumFacing[] facings = { null, EnumFacing.EAST, EnumFacing.WEST, EnumFacing.NORTH, EnumFacing.SOUTH, EnumFacing.UP, EnumFacing.DOWN};
    private static void renderModel(IBakedModel model, VertexFormat fmt)
    {
        ...
        {
            for (BakedQuad bakedquad : model.getQuads(null, facing, 0))
            {
